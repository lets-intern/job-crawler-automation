...
- [ ] 1.0 목록 URL 하나로 등록이 끝나게 한다
    ...
    - [ ] 1.2 등록 화면에서 렌더 모드 선택을 없앤다
        - [ ] 1.2.1 (추가) 정적으로 목록이 안 잡히면 등록이 스스로 렌더로 올려 생성한다
            ...
            - [ ] 1.2.1.V 검증: 정적은 껍데기, 렌더는 항목이 있는 가짜 소스로 pytest
        - [ ] 1.2.2 (추가) 항목 셀렉터가 넓게 잡히면 제목이 있는 반복 요소로 좁힌다
