...
- [ ] 1.0 호출 자리를 제공자에서 떼어내고 넷을 붙인다
    ...
    - [ ] 1.1 네 제공자의 현재 문서를 확인하고 조사 결과를 적는다
        ...
        - [ ] 1.1.V 검증: 표의 모든 모델 ID 와 파라미터 이름이 각 제공자 공식 문서에 있는
              값인지 대조한다. 기억으로 쓴 값이 하나도 없어야 한다

    - [ ] 1.2 `app/llm/` 에 제공자 항목과 공통 타입을 만든다
        ...
        - [ ] 1.2.V 검증: `mypy app` 통과, 기존 pytest 전체 통과. 이 작업은 동작을 바꾸지
    ...
    - [ ] 1.5 기능마다 제공자와 모델을 환경변수로 고른다
        ...
        - [ ] 1.5.V 검증: `tests/test_config.py` 에 기본값과 빈 문자열 처리를 더한다.
